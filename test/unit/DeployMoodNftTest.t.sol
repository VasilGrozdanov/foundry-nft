...
contract DeployMoodNftTest is Test {
    ...
    function testViewSvgToImageUri() external view {
        ...
        string memory acualUri = moodNftDeployer.svgToImageURI(svg);
        assertEq(acualUri, expectedUri);
    }
}
